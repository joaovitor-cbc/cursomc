...
import com.example.ecommerceapi.domain.ItemPedido;
import com.example.ecommerceapi.domain.Pagamento;
import com.example.ecommerceapi.domain.PagamentoComBoleto;
import com.example.ecommerceapi.domain.PagamentoComCartao;
import com.example.ecommerceapi.domain.Pedido;
import com.example.ecommerceapi.domain.Produto;
import com.example.ecommerceapi.domain.enums.EstadoPagamento;
...
import com.example.ecommerceapi.repositories.ItemPedidoRepository;
import com.example.ecommerceapi.repositories.PagamentoRepository;
import com.example.ecommerceapi.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		//criando Cliente
		Cliente cli1 = new Cliente(null, "Maria Silva", "joaovitor.novacruz@gmail.com",
				"36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		

		Cliente cli2 = new Cliente(null, "Ana Costa", "joaovitor.novacruz@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		...
		//criando mascara para data e hora
		...
		//fazendo associação do primeiro pagamento com primeiro pedido
		ped1.setPagamento(pagto1);
		
		//criando Pagamento
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"), null);
		
		//fazendo associação do segundo pagamento com segundo pedido
		ped2.setPagamento(pagto2);
		
		//fazendo associação dos pedidos para o cliente
		...
		//Associando ItemPedido ao Pedido
		ped1.getItens().addAll(Arrays.asList(ip1, ip2));
		ped2.getItens().addAll(Arrays.asList(ip3));
		
		//associando ItemPedido ao Produto
